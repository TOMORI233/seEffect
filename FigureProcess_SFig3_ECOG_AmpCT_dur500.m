...
%% Paths
DATAPATHs = dir("..\DATA\ECOG\MAT DATA\pre\SEeffect_Locs_Multi__AmpDiff_LocS12_nPeriod2_Dur500\**\data.mat");
...
dur = 500; % ms
pos = [0	25	50	75	100	150	250	350	400	425	450	475]; % ms
...
plotRawWaveMulti(chData(1, :), window, [], [1, 1], 21);

%% Permutation test
try
    % load("perm_test ECOG_Amp_dur500.mat", "stats", "statsOnset");
    load("perm_test ECOG_Amp_dur500.mat", "statsOnset");
catch ME
    for dIndex = 1:numel(data)
    ...
    % save("perm_test ECOG_Amp_dur500.mat", "stats", "statsOnset");
    save("perm_test ECOG_Amp_dur500.mat", "statsOnset");
end
