...
for mIndex = 1:length(MATPATHs)
    ...
    mPrint(gcf, fullfile(FIGUREPATHs(mIndex), "103.jpg"), "-djpeg", "-r300");

    save(fullfile(SAVEPATHs(mIndex), "103_res.mat"), "trialAll", "deltaAmp", "ratioControl", "ratioHead", "ratioMid", "ratioTail", "fitResMid", "fitResHead", "fitResTail");
