...
%% Paths
DATAPATHs = dir("..\DATA\ECOG\MAT DATA\pre\SEeffect_Locs_Multi__FreqDiff_LocS14_nPeriod2_Dur1000_45dB\**\data.mat");
...
%% Permutation test
try
    load("perm_test ECOG_Freq_dur1000_att.mat", "stats", "statsOnset");
catch ME
    for dIndex = 1:numel(data)
    ...
    save("perm_test ECOG_Freq_dur1000_att.mat", "stats", "statsOnset");
end
