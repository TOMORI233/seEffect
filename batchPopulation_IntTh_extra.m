...
MATPATHs = dir("DATA\MAT DATA\single\**\103_res.mat");
...
%% Copy figures
FIGUREPOPUPATH = "Figures\Population\103";
mkdir(FIGUREPOPUPATH);
arrayfun(@(x, y) copyfile(fullfile(x, "103.jpg"), fullfile(FIGUREPOPUPATH, strcat(y, " IntTh-1kHz.jpg"))), FIGURESINGLEPATHs, SUBJECTs);
